...
export default function CircularProgressBarBlock({
	label,
	activeColor,
	percent,
	additionalClasses,
	...
	return (
		<div
			className={`p-5 flex flex-col items-center justify-between gap-6 border border-secondaryGray rounded-[20px] ${
				additionalClasses || ""
			}`}>
