...
export default function HomePage() {
	...
	const formattedDate = `${currentMonth} (${currentDate.getDate()}.${
		currentDate.getMonth() + 1
	}.${currentDate.getFullYear()} - ${futureDate.getDate()}.${
		futureDate.getMonth() + 1
	}.${futureDate.getFullYear()})`;

	console.log(formattedDate);

	// const { get_results_for_periods } = usePeriods();
		...
		return (
			<section>
				<div>
					...
					<Dropdown additionalClasses="mt-6 mb-4" text={formattedDate} />
				...
				<div
					className="w-8 h-8 bg-dark fixed bottom-4 right-4 rounded-full flex-middle cursor-pointer"
